...
% kmeans++ algorithm (MATLABs prewritten version) to cluster the image and find
...
% sort the colours arbitrarily so that they always output in the same order
colours = sortrows(colours);
